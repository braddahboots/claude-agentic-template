...
## Root
- `CLAUDE.md` — Project-level instructions for Claude Code (system prompt)
...
### `.claude/rules/` — Contextual Instructions
...
- `rules/domain-rule.md.tmpl` — Template for domain-specific rules
